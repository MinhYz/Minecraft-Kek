...
{Fore.WHITE}[{Fore.CYAN}6{Fore.WHITE}] Mail Access {Fore.BLUE}| Check if your combos are mail access
{Fore.WHITE}[{Fore.CYAN}7{Fore.WHITE}] Exit{Fore.BLUE} | Close the checker
''')
        ...
        if mode == "4":
            ...
            if __name__ == '__main__':
                ...
                symbo = f'{Fore.WHITE}[{Fore.LIGHTE_EX}'
                symbo2 = f'{Fore.WHITE}[{Fore.LIGHTGREEN_EX}»{Fore.WHITE}]{ForeTGREEN_EX}+{Fore.WHITE}]{Fore.LIGHTWHI.LIGHTWHITE_EX}'
            ...
            PORT = 25565
            windll.kernel32.SetConsoleTitleW(
                f'Minecraftchecker V{self.version} | Module: BanChecker (Maybe Not Work)')
            ...
            if __name__ == '__main__':
                ...
                RPC.update(details="Idk", large_image="minecraft")
                ...
                import os
                system('cls')
                os.system('"Minecraftchecker.exe"')
            ...
            urls.append('https://www.proxyscan.io/download?type=http')
            urls.append('https://www.proxyscan.io/download?type=https')
            urls.append('https://www.proxyscan.io/download?type=socks4')
    ...
    def Refreshconsole(self):
        while True:
            ...
            RPC.update(details="Nfa:" + str(Counter.nfa) + "Sfa:" + str(Counter.sfa), state=" Time Checking: " + str(self.Timeused()) , large_image="minecraft")
            system('cls')
            self.prints(result)
    ...
    def title(self):
        while True:
            if Checker.profit.profit:
                ...
                RPC.update(details="Checked: " + str(Counter.bad + Counter.hits) + '/' +str(Total) + " Hits: " + str(Counter.hits) +" CPM: " + str(Counter.cpm), state=" Time Checking: " + str(self.Timeused()) , large_image="minecraft")
                ...
                RPC.update(details="Checked: " + str(Counter.bad + Counter.hits) + '/' + str(Total) + " Hits: " + str(
                    Counter.hits) + " CPM: " + str(Counter.cpm), state=" Time Checking: " + str(self.Timeused()),
    ...
    def proxy_cpm(self):
        while True:
            ...
            RPC.update(details="Proxy Good: " + str(Counter.mojangunbanned) + "Proxy Bad: " + str(Counter.invalid),
                       large_image="minecraft")
